...
exports.patchCategoryById = async (req, res, next) => {
  ...
  if (
    ...
    req.body.colaborators == null &&
    req.body.createdBy == null &&
    req.body.weightsCompleted == null &&
    req.body.contributions == null &&
    req.body.overAllWeight == null &&
  ...
  const patchableData = {
    ...
    weightsCompleted:
      req.body.weightsCompleted != null
        ? req.body.weightsCompleted
        : CategoryData.weightsCompleted,
    contributions:
      req.body.contributions != null
        ? req.body.contributions
        : CategoryData.contributions,
    overAllWeight:
      req.body.overAllWeight != null
        ? req.body.overAllWeight
        : CategoryData.overAllWeight,
    tasksCount:
      req.body.tasksCount != null
        ? req.body.tasksCount
        : CategoryData.tasksCount,
  };
  try {
    const patchedData = await categories.findByIdAndUpdate(
      CategoryID,
      { $set: { ...patchableData } },
      { new: true },
    );
