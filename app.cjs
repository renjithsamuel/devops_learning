...
const allowedOrigins = [
  ...
  "https://taskreporter.vercel.app/dashboard",
  "https://taskreporter.vercel.app/chat",
  "https://taskreporter.vercel.app/reports",
  "https://taskreporter.vercel.app/settings",
  "http://localhost:5173",
...
const {
  router: chatByDateRoutes,
  chatSocketHandler,
} = require("./Routes/ChatsByDatesRouter");
...
// const port = process.env.PORT || 30799;
const port = process.env.PORT || 80; // for AWS http only allows 80
