...
const {
  getChatByDates,
  getPreviousChats,
  getUniqueChatByDateById,
  postChatByDate,
  patchChatByDateById,
  deleteChatByDateById,
  deleteManyChatsByCategoryId,
} = require("../Controllers/ChatByDatesController");
...
const chatSocketHandler = (io) => {
  io.on("connection", (socket) => {
    ...
    socket.on("joinRoom", (room) => {
      ...
      console.log(
        `Number of clients in room ${room}: ${roomClients ? roomClients.size : 0}`,
      );
    });
